    ...
    <div class="login-box">
        ...
        <form class="form-login flex flex-column gap24" method="POST" action="{{ route('register') }}">
            ...
            <fieldset class="email">
                ...
                <input class="flex-grow" type="email" placeholder="Enter your email address" name="email" tabindex="0"
                    value="" aria-required="true" required="">
            </fieldset>
            <fieldset class="password">
                <div class="body-title mb-10">Password <span class="tf-color-1">*</span></div>
                <input class="password-input" type="password" placeholder="Enter your password" name="password"
            ...
            <fieldset class="password">
                ...
                <input class="password-input" type="password" placeholder="Enter your password again"
                    name="password_confirmation" tabindex="0" value="" aria-required="true" required="">
                <span class="show-pass">
                    <i class="icon-eye view"></i>
                    <i class="icon-eye-off hide"></i>
                </span>
