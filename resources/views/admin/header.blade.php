        ...
        <div class="header-left">
            <a href="index.html">
                <img class="" id="logo_header_mobile" alt=""
                     src="admin/images/logo/logo.png" data-light="admin/images/logo/logo.png"
                     data-dark="admin/images/logo/logo-dark.png" data-width="154px"
                     data-height="52px" data-retina="admin/images/logo/logo@2x.png">
            </a>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end has-content"
                        ...
                        <li>
                            <div class="noti-item w-full wg-user active">
                                <div class="image">
                                    <img src="admin/images/avatar/user-12.png" alt="">
                                </div>
                                <div class="flex-grow">
                                    <div class="flex items-center justify-between">
                        ...
                        <li>
                            <div class="noti-item w-full wg-user active">
                                <div class="image">
                                    <img src="admin/images/avatar/user-13.png" alt="">
                                </div>
                                <div class="flex-grow">
                                    <div class="flex items-center justify-between">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end has-content"
                        ...
                        <li>
                            <ul class="list-apps">
                                <li class="item">
                                    <div class="image">
                                        <img src="admin/images/apps/item-1.png" alt="">
                                    </div>
                                    <a href="#">
                                ...
                                <li class="item">
                                    <div class="image">
                                        <img src="admin/images/apps/item-2.png" alt="">
                                    </div>
                                    <a href="#">
                                ...
                                <li class="item">
                                    <div class="image">
                                        <img src="admin/images/apps/item-3.png" alt="">
                                    </div>
                                    <a href="#">
                                ...
                                <li class="item">
                                    <div class="image">
                                        <img src="admin/images/apps/item-5.png" alt="">
                                    </div>
                                    <a href="#">
                                ...
                                <li class="item">
                                    <div class="image">
                                        <img src="admin/images/apps/item-6.png" alt="">
                                    </div>
                                    <a href="#">
                                ...
                                <li class="item">
                                    <div class="image">
                                        <img src="admin/images/apps/item-7.png" alt="">
                                    </div>
                                    <a href="#">
                                ...
                                <li class="item">
                                    <div class="image">
                                        <img src="admin/images/apps/item-8.png" alt="">
                                    </div>
                                    <a href="#">
                                ...
                                <li class="item">
                                    <div class="image">
                                        <img src="admin/images/apps/item-9.png" alt="">
                                    </div>
                                    <a href="#">
                            ...
                            <a href="login.html" class="user-item">
                                ...
                                <div class="body-title-2">
                                    <form action="{{ route('logout') }}" method="POST">
                                        @csrf
                                        <button type="submit" class="body-title-2"
                                                style="border: none;padding: 0;">Log
                                            out</button>
                                    </form>
